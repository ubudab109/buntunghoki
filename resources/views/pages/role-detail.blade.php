      ...
      <div class="col-md-12">
        <form action="{{route('role.update', $role->id)}}" method="POST">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="col-md-12">
                <input type="text" name="name" id="name" class="form-control" value="{{ucwords($role->name)}}">
              </div>
            </div>
          </div>
          <div class="card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" name="permissions[]" type="checkbox" id="{{$item['id']}}" value="{{$item['name']}}" {{$item['is_assign'] ? 'checked' : ''}}>
